# Generated by Django 2.1.5 on 2019-04-25 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_fee', models.IntegerField(db_column='Fee')),
            ],
            options={
                'db_table': 'Classes',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('student_id', models.ForeignKey(db_column='Id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='SMS.Person')),
